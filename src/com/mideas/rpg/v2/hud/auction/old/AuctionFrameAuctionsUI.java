...
public class AuctionFrameAuctionsUI {
	...
	final InputBox goldStartingPriceEditBox = new InputBox("AuctionHouseFrameGoldStartingPriceInputBox", this.GOLD_STARTING_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.STARTING_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.GOLD_PRICE_EDIT_BOX_WIDTH, 6, 5, this.GOLD_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
	...
	final InputBox silverStartingPriceEditBox = new InputBox("AuctionHouseFrameSilverStartingPriceInputBox", this.SILVER_STARTING_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.STARTING_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.SILVER_PRICE_EDIT_BOX_WIDTH, 2, 5, this.SILVER_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
	...
	final InputBox copperStartingPriceEditBox = new InputBox("AuctionHouseFrameCopperStartingPriceInputBox", this.COPPER_STARTING_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.STARTING_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.COPPER_PRICE_EDIT_BOX_WIDTH, 2, 5, this.COPPER_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
	...
	final InputBox goldBuyoutPriceEditBox = new InputBox("AuctionHouseFrameGoldBuyoutPriceInputBox", this.GOLD_BUYOUT_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.BUYOUT_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.GOLD_PRICE_EDIT_BOX_WIDTH, 6, 5, this.GOLD_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
	...
	final InputBox silverBuyoutPriceEditBox = new InputBox("AuctionHouseFrameSilverBuyoutPriceInputBox", this.SILVER_BUYOUT_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.BUYOUT_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.SILVER_PRICE_EDIT_BOX_WIDTH, 2, 5, this.SILVER_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
	...
	final InputBox copperBuyoutPriceEditBox = new InputBox("AuctionHouseFrameCopperBuyoutPriceInputBox", this.COPPER_BUYOUT_PRICE_EDIT_BOX_X*Mideas.getDisplayXFactor(), this.BUYOUT_PRICE_EDIT_BOX_Y*Mideas.getDisplayYFactor(), this.COPPER_PRICE_EDIT_BOX_WIDTH, 2, 5, this.COPPER_PRICE_EDIT_BOX_WIDTH, FontManager.get("FRIZQT", 11), true, 0, 3) {
