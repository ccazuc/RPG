...
public class GoldFrame {
	...
	public static void draw() throws FileNotFoundException, SQLException {
		...
		TTF2.coin.drawStringShadow(Display.getWidth()+x+130-TTF2.coin.getWidth(String.valueOf(Mideas.getCurrentGold()-Mideas.calcGoldCoin()*10000-Mideas.calcSilverCoin()*100)), Display.getHeight()/2+y+166, String.valueOf(Mideas.getCurrentGold()-Mideas.calcGoldCoin()*10000-Mideas.calcSilverCoin()*100), Color.white, Color.black, 1, 1, 1);
