...
public class GoldFrame {
	...
	public static void draw() {
		if(ContainerFrame.getBagOpen(0)) {
			...
			FontManager.get("FRIZQT", 11).drawStringShadow(Display.getWidth()+x, Display.getHeight()+y+1, String.valueOf(copper), Colors.WHITE, Colors.BLACK, 1, 0, 0);
			...
			FontManager.get("FRIZQT", 11).drawStringShadow(Display.getWidth()+x, Display.getHeight()+y+1, String.valueOf(silver), Colors.WHITE, Colors.BLACK, 1, 0, 0);
			...
			FontManager.get("FRIZQT", 11).drawStringShadow(Display.getWidth()+x, Display.getHeight()+y+1, String.valueOf(gold), Colors.WHITE, Colors.BLACK, 1, 0, 0);
		}
	}
}
