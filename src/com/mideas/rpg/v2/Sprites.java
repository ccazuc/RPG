...
public class Sprites {
	...
	public static void initBG() throws IOException {
		...
		loading_screen_bar1 = new Texture("sprite/interface/loadingbar.png");
		loading_screen_bar2 = new Texture("sprite/interface/loadingscreen_1.png");
		loading_screen_bar3 = new Texture("sprite/interface/loadingscreen_2.png");
		loading_screen_bar4 = new Texture("sprite/interface/loadingscreen_3.png");
		loading_screen_bar5 = new Texture("sprite/interface/loadingscreen_4.png");
		loading_screen_bar6 = new Texture("sprite/interface/loadingscreen_5.png");
	}
	
	public static boolean sprite() throws IOException {
		gem_frame = new Texture("sprite/interface/gem_frame.png");
		...
		gem_red = new Texture("sprite/interface/gem_red.png");
		gem_blue = new Texture("sprite/interface/gem_blue.png");
		gem_yellow = new Texture("sprite/interface/gem_yellow.png");
		gem_meta = new Texture("sprite/interface/gem_meta.png");
		close_bag_button_down = new Texture("sprite/interface/close_button_bag_down.png");
		close_bag_button_down_hover = new Texture("sprite/interface/close_button_bag_down_hover.png");
		...
		close_bag_button = new Texture("sprite/interface/close_button_bag.png");
		close_bag_button_hover = new Texture("sprite/interface/close_button_bag_hover.png");
		...
		character_frame_open = new Texture("sprite/interface/buttons/buttons/UI-MicroButton-CharacterNightElf-Down.png");
		...
		chat_button = new Texture("sprite/interface/chat_button.png");
		craft_frame = new Texture("sprite/interface/craft_frame.png");
		...
		close_spell_book_hover = new Texture("sprite/interface/close_spell_book_hover.png");
		spellbook_page1 = new Texture("sprite/interface/spellbook.png");
		spellbook_spell_bg = new Texture("sprite/interface/spellbook_spell_bg.png");
		spellbook_spell_bg = new Texture("sprite/interface/spellbook_spell_bg.png");
		spellbook_spell_bg_grey = new Texture("sprite/interface/spellbook_spell_bg_grey.png");
		escape_frame = new Texture("sprite/interface/escape_frame.png");
		level = new Texture("sprite/interface/level.png");
		un_green_talent = new Texture("sprite/interface/1_green_talent.png");
		deux_green_talent = new Texture("sprite/interface/2_green_talent.png");
		trois_green_talent = new Texture("sprite/interface/3_green_talent.png");
		quatre_green_talent = new Texture("sprite/interface/4_green_talent.png");
		trois_yellow_square_talent = new Texture("sprite/interface/yellow_3-3_talent.png");
		deux_yellow_square_talent = new Texture("sprite/interface/yellow_2-2_talent.png");
		cinq_yellow_square_talent = new Texture("sprite/interface/yellow_5-5_talent.png");
		left_second_line_talent = new Texture("sprite/interface/left_second_line_talent.png");
		...
		warrior_talent_tree = new Texture("sprite/interface/warrior_talent_tree.png");
	...
	public static boolean sprite9() throws IOException {
		...
		bag4 = new Texture("sprite/interface/4.png");
		bag6 = new Texture("sprite/interface/6.png");
		bag8 = new Texture("sprite/interface/8.png");
		bag10 = new Texture("sprite/interface/10.png");
		bag12 = new Texture("sprite/interface/12.png");
		bag14 = new Texture("sprite/interface/14.png");
		bag16 = new Texture("sprite/interface/16.png");
		bag18 = new Texture("sprite/interface/18.png");
		bag20 = new Texture("sprite/interface/20.png");
		back_bag = new Texture("sprite/interface/backbag.png");
		back_bag2 = new Texture("sprite/interface/backbag.png");
		back_bag3 = new Texture("sprite/interface/backbag.png");
		back_bag4 = new Texture("sprite/interface/backbag.png");
		...
		close_button_inventory_hover = new Texture("sprite/interface/close_button_inventory_hover.png");
		close_button_inventory_down = new Texture("sprite/interface/close_button_inventory_down.png");
		close_button_inventory_down_hover = new Texture("sprite/interface/close_button_inventory_down_hover.png");
		close_shop_hover = new Texture("sprite/interface/close_shop_hover.png");
