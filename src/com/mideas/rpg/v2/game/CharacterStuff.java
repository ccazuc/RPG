...
public class CharacterStuff {
	...
	public static void getBagItems() throws SQLException {
		...
		while(i < 97) {
			...
			while(x <= 3) {
				if(i == 96 && x == 3) {
					builder.append("slot"+Integer.toString(i)+"_gem"+Integer.toString(x)+" ");
				}
				else {
					builder.append("slot"+Integer.toString(i)+"_gem"+Integer.toString(x)+", ");
				}
