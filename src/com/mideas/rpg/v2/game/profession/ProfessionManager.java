	...
	public static void LoadAllCraft() {	
		try {
			...
			while(statement.fetch()) {
				...
				Item ressource1 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource1Amount = Integer.parseInt(tempItem.split(":")[1]);
				tempItem = statement.getString();
				Item ressource2 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource2Amount = Integer.parseInt(tempItem.split(":")[1]);
				tempItem = statement.getString();
				Item ressource3 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource3Amount = Integer.parseInt(tempItem.split(":")[1]);
				tempItem = statement.getString();
				Item ressource4 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource4Amount = Integer.parseInt(tempItem.split(":")[1]);
				tempItem = statement.getString();
				Item ressource5 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource5Amount = Integer.parseInt(tempItem.split(":")[1]);
				tempItem = statement.getString();
				Item ressource6 = getItem(Integer.parseInt(tempItem.split(":")[0]));
				int ressource6Amount = Integer.parseInt(tempItem.split(":")[1]);
